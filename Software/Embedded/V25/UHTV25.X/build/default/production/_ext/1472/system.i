...
void __attribute__((picinterrupt(("low_priority")))) SYS_InterruptLow(void)
{
    __nop();
    __nop();
}

void __attribute__((picinterrupt(("high_priority")))) SYS_InterruptHigh(void)
{
